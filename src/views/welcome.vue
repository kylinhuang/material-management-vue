            ...
            <!--<el-col :span="11">-->
                <!--<div class="grid-content bg-purple">-->
                    <!--<el-card style="min-height:650px;">-->
                        ...
                        <!--</el-carousel>-->
                        <!--&lt;!&ndash;<aplayer&ndash;&gt;-->
                                <!--&lt;!&ndash;style="margin-top:20px;margin-bottom:30px;"&ndash;&gt;-->
                                <!--&lt;!&ndash;autoplay&ndash;&gt;-->
                                <!--&lt;!&ndash;:music="{&ndash;&gt;-->
                  <!--&lt;!&ndash;title: '给我一个理由忘记',&ndash;&gt;-->
                  <!--&lt;!&ndash;artist: 'A-Lin',&ndash;&gt;-->
                  <!--&lt;!&ndash;src: 'http://music.163.com/song/media/outer/url?id=25640799.mp3',&ndash;&gt;-->
                  <!--&lt;!&ndash;pic: 'http://p2.music.126.net/0POVOSSjqgVoOUGc5haWBQ==/109951163392311918.jpg'&ndash;&gt;-->
              <!--&lt;!&ndash;}"&ndash;&gt;-->
                                <!--&lt;!&ndash;:list="musicList"&ndash;&gt;-->
                        <!--&lt;!&ndash;&gt;&ndash;&gt;-->
                            <!--&lt;!&ndash;&ndash;&gt;-->
                        <!--&lt;!&ndash;</aplayer>&ndash;&gt;-->
                        <!--&lt;!&ndash;<el-divider>其他项目</el-divider>&ndash;&gt;-->
                        <!--&lt;!&ndash;<el-row :gutter="20">&ndash;&gt;-->
                            <!--&lt;!&ndash;<el-col :span="6"><div class="grid-content bg-purple"><el-button @click="getPage('http://116.85.25.106/backend/loginPage.do')">通用管理系统</el-button></div></el-col>&ndash;&gt;-->
                            <!--&lt;!&ndash;<el-col :span="6"><div class="grid-content bg-purple"><el-button @click="getPage('http://www.zykcoderman.xyz/')">社区项目</el-button></div></el-col>&ndash;&gt;-->
                            <!--&lt;!&ndash;<el-col :span="6"><div class="grid-content bg-purple"><el-button @click="getPage('http://116.85.25.106')">商城项目</el-button></div></el-col>&ndash;&gt;-->
                            <!--&lt;!&ndash;<el-col :span="6"><div class="grid-content bg-purple"><el-button @click="getPage('https://github.com/zykzhangyukang')">Githhub</el-button></div></el-col>&ndash;&gt;-->
                        <!--&lt;!&ndash;</el-row>&ndash;&gt;-->
