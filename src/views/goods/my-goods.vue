	...
	<div id="productCategroys">
		...
		<el-card class="box-card">
			<el-container style="margin-bottom:20px;">
				<el-alert
						show-icon
						title="提示:  价格高于市场建议价格,可能无法通过审核。特殊情况 请联系 资源管理中心 工作人员"
						type="warning">
				</el-alert>
			</el-container>
			<el-row :gutter="6">
			...
			<template>
				...
				>
					...
					<el-table-column prop="merchant_image_url" label="图片" align="center" width="150px" padding="0px">
						...
						<template slot-scope="scope">
							<el-popover placement="right" trigger="hover">
								...
								<img slot="reference" :src="scope.row.merchant_image_url"
								     :alt="scope.row.merchant_image_url"
					...
					<el-table-column prop="remark" label="品牌/质量"></el-table-column>
					...
					<el-table-column prop="proposedPrice" label="建议价格(元)"></el-table-column>
			...
			<el-dialog title="添加物资" :visible.sync="addDialogVisible" width="50%" @close="closeAddDialog">
                <span>
	                ...
	                <el-form
		                ...
		                <el-form-item label="品牌/质量" prop="remark">
			...
			<el-dialog title="修改商品信息" :visible.sync="editDialogVisible" width="50%" @close="closeEditDialog">
				...
				<span slot="footer" class="dialog-footer">
                    ...
                    <el-button type="primary" @click="editGoods" :disabled="btnDisabled"
    ...
    export default {
        data() {
            return {
                ...
                addRules: {
                    ...
                    remark: [
                        {required: true, message: "请输入物资说明品牌/质量", trigger: "blur"},
        ...
        methods: {
            ...
            async getWarehousingSupplies() {
                const {data: res} = await this.$http.get("goods/findList", {
