<template>
	<div id="productCategroys">
		...
		<el-breadcrumb separator="/" style="padding-left:10px;padding-bottom:10px;font-size:12px;">
			...
			<el-breadcrumb-item>采购计划列表</el-breadcrumb-item>
		</el-breadcrumb>
		<!-- 右侧卡片区域 -->
		<el-card class="box-card">
			...
			<template>
				...
				>
					...
					<!--<el-table-column prop="projectNum" :show-overflow-tooltip='true' label="项目编号"></el-table-column>-->
							...
							<!--<span v-if="scope.row.status==0">-->
                                ...
                                <!--<el-popconfirm-->
	                                ...
	                                <!--<el-button type="text" slot="reference" size="mini"-->
	                                           <!--icon="el-icon-s-operation">回收站</el-button>-->
			...
			<!-- 物资添加弹出框 -->
			<el-dialog title="创建项目" :visible.sync="addDialogVisible" width="50%" @close="closeAddDialog">
            <span>
                <el-form
		                size="mini"
		                :model="addRuleForm"
            ...
            <el-row>
              <!--<el-col :span="12">-->
	            ...
	            <!--<el-form-item label="物资管理" prop="allocatorId">-->
	            <!--<el-input v-model="addRuleForm.allocatorId"></el-input>-->
	            <!--</el-form-item>-->
	            <!--</div>-->
	            <!--</el-col>-->
              ...
              <el-col :span="12">
                <div class="grid-content bg-purple">
                    ...
                    <el-form-item label="物资管理" required>
                      <el-select v-model="addRuleForm.allocatorId" placeholder="请指派物资管理人员" style="width: 100%">
                        <el-option
	            ...
	            <!--<el-col :span="12">-->
	            <!--<div class="grid-content bg-purple">-->
	            <!--<el-form-item label="物资管理" prop="categoryKeys">-->
	            <!--<el-cascader-->
	            <!--:options="allocators"-->
	            <!--clearable-->
	            <!--filterable-->
              ...
              <el-col :span="12">
                <div class="grid-content bg-purple-light">
                  <el-form-item label="优先级别" prop="sort">
                    <el-input-number v-model="addRuleForm.sort" :min="1" :max="10" label="优先级别"></el-input-number>
                  </el-form-item>
                </div>
              </el-col>
            </el-row>
          ...
          <el-button type="primary" @click="add" :disabled="btnDisabled" :loading="btnLoading">确 定</el-button>
			...
			>
              ...
              <el-col :span="12">
                <div class="grid-content bg-purple-light">
                  <el-form-item label="优先级别" prop="sort">
                    <el-input-number v-model="editRuleForm.sort" :min="1" :max="10" label="优先级别"></el-input-number>
                  </el-form-item>
                </div>
              </el-col>
            </el-row>
