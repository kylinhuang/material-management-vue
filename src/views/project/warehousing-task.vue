		...
		<el-card class="box-card">
			...
			<template>
				...
				<el-table :data="tableData" border stripe style="width: 100%;">
					...
					<el-table-column prop="sort" label="发货数量" width="80px">
						<template slot-scope="scope">
						...
						<template slot-scope="scope">
							...
							<div   >
								...
								<!--<el-popconfirm title="是否验收合格？" >-->
									<el-button type="text" size="mini" icon="el-icon-finished" v-if="scope.row.status==3"
									           @click="showWarehousingDialog(scope.row)">入库
									</el-button>
								<!--</el-popconfirm>-->

								<!--<el-popconfirm title="质量不合格退回吗？" >-->
									<el-button type="text" size="mini" icon="el-icon-finished" v-if="scope.row.status==3"
									           @click="updateStatus(scope.row,5)">驳回
									</el-button>
								<!--</el-popconfirm>-->
					...
					>
						...
						<el-row v-if="null !=editRuleForm.product">
							...
							<el-col :span="12">
								...
								<div class="grid-content bg-purple-light">
									<el-form-item label="建议价格(元)" prop="proposedPrice">
										<el-input v-model="editRuleForm.product.proposedPrice" :disabled="true"></el-input>
									</el-form-item>
						...
						<el-form-item label="发货图片" prop="imageUrl">
			...
			<el-dialog
					title="入库"
					:visible.sync="editWarehousingDialogVisible"
					width="50%"
					@close="closeWarehousingDialog" >

				<span>
					<el-form
							size="mini"
							:model="warehousingRuleForm"
							:rules="addRules"
							ref="editRuleFormRef"
							label-width="100px"
							class="demo-ruleForm"
					>
						...
						<el-row v-if="null !=warehousingRuleForm.product">

							<el-col :span="12">
								<div class="grid-content bg-purple">

									<el-form-item label="物资名称" prop="unit">
										<el-input v-model="warehousingRuleForm.product.name" :disabled="true"></el-input>
									</el-form-item>
								</div>
							</el-col>
							...
							<el-col :span="12">
								<div class="grid-content bg-purple-light">
									<el-form-item label="物资型号" prop="model">
										<el-input v-model="warehousingRuleForm.product.model" :disabled="true"></el-input>
									</el-form-item>
								</div>
							</el-col>
						</el-row>
						...
						<el-row v-if="null !=warehousingRuleForm.product">
							...
							<el-col :span="12">
								<div class="grid-content bg-purple-light">
									<el-form-item label="单位" prop="unit">
										<el-input v-model="warehousingRuleForm.product.unit" :disabled="true"></el-input>
									</el-form-item>
								</div>
							</el-col>
							...
							<el-col :span="12">
								<div class="grid-content bg-purple-light">
									<el-form-item label="厂商品牌" prop="remark">
										<el-input v-model="warehousingRuleForm.product.remark" :disabled="true"></el-input>
									</el-form-item>
								</div>
							</el-col>
						</el-row>
						...
						<el-row v-if="null !=warehousingRuleForm.product">
							...
							<el-col :span="12">
								<div class="grid-content bg-purple-light">
									<el-form-item label="数量" prop="productNumber">
										<el-input v-model="warehousingRuleForm.productNumber" :disabled="true"></el-input>
									</el-form-item>
								</div>
							</el-col>
							...
							<el-col :span="12">
								...
								<div class="grid-content bg-purple-light">
									<el-form-item label="建议价格(元)" prop="proposedPrice">
										<el-input v-model="warehousingRuleForm.product.proposedPrice" :disabled="true"></el-input>
									</el-form-item>
						...
						<el-row >
							...
							<el-col :span="12">
								<div class="grid-content bg-purple-light">
									<el-form-item label="发货数量" prop="deliveryNumber">
										<el-input v-model="warehousingRuleForm.deliveryNumber" :disabled="true" ></el-input>
									</el-form-item>
								</div>
							</el-col>
							...
							<el-col :span="12">
								<div class="grid-content bg-purple-light">
									<el-form-item label="发货价格" prop="deliveryPrice">
										<el-input v-model="warehousingRuleForm.deliveryPrice" :disabled="true" ></el-input>
									</el-form-item>
								</div>
							</el-col>
						...
						<el-row >
							...
							<el-col :span="12">
								<div class="grid-content bg-purple-light">
									<el-form-item label="入库数量" prop="deliveryNumber">
										<el-input v-model="warehousingRuleForm.warehousingNumber"  ></el-input>
									</el-form-item>
								</div>
							</el-col>
						...
						<el-collapse v-model="activeNames"  >
							...
							<el-collapse-item title="商品信息" name="1" v-if="null !=warehousingRuleForm.goods" >
								<div>商品名称：{{warehousingRuleForm.goods.name}}</div>
								<div>商品型号：{{warehousingRuleForm.goods.model}}</div>
								<div>商品价格：{{warehousingRuleForm.goods.price}}元</div>

								<div>供应商名称：{{warehousingRuleForm.goods.merchantUserName}}</div>
								<div>供应商信息：{{warehousingRuleForm.goods.merchantNickName}}</div>
								<div>供应商电话：{{warehousingRuleForm.goods.merchantPhoneNumber}}</div>


								<div>区域： {{warehousingRuleForm.goods.merchantProvince}}/{{warehousingRuleForm.goods.merchantCity}}/{{warehousingRuleForm.goods.merchantOrigin}}</div>
								<div>地址： {{warehousingRuleForm.goods.merchantAddress}}</div>
							</el-collapse-item>

							<el-collapse-item title="仓储" name="2" v-if="null !=warehousingRuleForm.warehousing">
								<div>仓储名称：{{warehousingRuleForm.warehousing.username}}</div>
								<div>仓储信息：{{warehousingRuleForm.warehousing.nickname}}</div>
								<div>仓储电话：{{warehousingRuleForm.warehousing.phoneNumber}}</div>

								<div>区域： {{warehousingRuleForm.warehousing.province}}/{{warehousingRuleForm.warehousing.city}}/{{warehousingRuleForm.warehousing.origin}}</div>
								<div>地址： {{warehousingRuleForm.warehousing.address}}</div>
							</el-collapse-item>


						</el-collapse>

						<el-form-item label="发货单" prop="imageUrl">
							...
							<el-upload
									...
									:limit="limitCount"
									accept="image/*"
									:on-success="editWarehousingHandleSuccess"
									:headers="headerObject"
									ref="upload2"
									:on-preview="warehousingHandlePictureCardPreview"
									:file-list="imgFilesList">
				...
				<span slot="footer" class="dialog-footer">
					...
					<el-button @click="editWarehousingDialogVisible = false">取 消</el-button>

					<el-button
							type="primary"
							@click="confirmWarehousing()"
							:disabled="btnDisabled"
							:loading="btnLoading"
					>确 定</el-button>
    ...
    export default {
        ...
        methods: {
            ...
            showWarehousingDialog(row) {
                this.warehousingRuleForm = row;
                this.editWarehousingDialogVisible = true;
